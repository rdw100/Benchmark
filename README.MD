...
|-------------- |-------------- |-------------- |---------:|---------:|---------:|---------:|------:|--------:|-------:|------:|------:|----------:|
| StringBuilder | .NET Core 2.2 | .NET Core 2.2 | 58.31 ns | 1.265 ns | 3.400 ns | 57.26 ns |  1.08 |    0.07 | 0.0483 |     - |     - |     152 B |
| StringBuilder | .NET Core 3.1 | .NET Core 3.1 | 56.72 ns | 1.210 ns | 1.295 ns | 56.42 ns |  1.01 |    0.04 | 0.0458 |     - |     - |     144 B |
| StringBuilder | .NET Core 5.0 | .NET Core 5.0 | 56.32 ns | 1.196 ns | 1.555 ns | 56.43 ns |  1.00 |    0.00 | 0.0459 |     - |     - |     144 B |
